...
feature "Boostrap cluster" do
  ...
  # User creation has already been done in register_and_configure.rb
  ...
  scenario "User accepts all minions" do
    ...
    puts ">>> Wait for minions to show up"
    # FIXME: implement better detection
    sleep 300
    ...
    puts ">>> Wait to prevent query timeout"
    # FIXME: implement better detection
    sleep 30
